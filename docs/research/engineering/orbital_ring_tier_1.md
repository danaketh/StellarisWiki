...
Allows the construction of massive, band-shaped starbases in stable orbit around colonized planets.
...
```json
{
  ...
  "sourceFile": "00_overlord_tech.txt",
  "tier": 3,
  "weight": 0
}
```
