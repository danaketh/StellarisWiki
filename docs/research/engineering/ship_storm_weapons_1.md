---
title: "Payload Padding"
description: "A new approach to alloy use in military applications significantly reduces the ability of cosmic storms to interfere with energy weaponry and explosive payloads."
sidebar_label: "Payload Padding"
tags: []
---
...
A new approach to alloy use in military applications significantly reduces the ability of cosmic storms to interfere with energy weaponry and explosive payloads.
...
```json
{
  ...
  "cost": 0,
  "description": "A new approach to alloy use in military applications significantly reduces the ability of cosmic storms to interfere with energy weaponry and explosive payloads.",
  "icon": "tech_ship_storm_weapons_1",
  "isDangerous": false,
  "isEvent": false,
  "isGestalt": false,
  "isMegacorp": false,
